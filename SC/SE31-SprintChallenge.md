...
- `price` (integer with default value 10)ac
...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  It is important to mantain high quality standards by reviewing code. In the process you can learn from someone else's code. Reading code can be compared to reading a book where anyone can educate on other's thought processes. I would pay attention to efficiency of the code and any existing typos. I would appreciate any comments from others in making my code more clean.
  
- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
  
  Containers are very useful to refer to objects. To access information containers can be a very usefull tool specially when the information is located in different sites or computers. Iterating over duplicate information can be very annoying without the use of containers. Containers can help simplify large amounts of data. It is always an efficient tool to use when dealing with data analysis. 
